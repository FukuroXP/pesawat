...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('pvktii/logo_pvktii.png')}}"/>
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600" rel="stylesheet">

    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/app-assets/vendors/css/vendors.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/app-assets/vendors/css/ui/prism.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/app-assets/vendors/css/tables/datatable/extensions/dataTables.checkboxes.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/app-assets/css/plugins/file-uploaders/dropzone.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/app-assets/css/pages/data-list-view.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/app-assets/css/pages/app-chat.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/app-assets/css/plugins/forms/wizard.css') }}">
...
{{--    @include('flash::message')--}}
    ...
    <script src="{{ asset('admin_assets/app-assets/vendors/js/ui/prism.min.js') }}"></script>
    <script src="{{ asset('admin_assets/app-assets/vendors/js/extensions/dropzone.min.js') }}"></script>
    ...
    <script src="{{ asset('admin_assets/app-assets/vendors/js/tables/datatable/dataTables.select.min.js') }}"></script>
    ...
    <script src="{{ asset('admin_assets/app-assets/vendors/js/extensions/jquery.steps.min.js') }}"></script>
    ...
    <script src="{{ asset('admin_assets/app-assets/js/scripts/pages/app-user.js') }}"></script>
    <!-- END: Theme JS-->

    <script src="{{ asset('admin_assets/app-assets/js/scripts/forms/wizard-steps.js') }}"></script>
