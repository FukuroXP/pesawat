    ...
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title mb-0">Report</h2>
                </div>
            </div>
        </div>
    </div>
...
{{--                            <button class="btn btn-outline-primary btn-modal" data-href="{{ route('reports.create') }}"><i class='feather icon-plus'></i> Tambah</button>--}}
                        </div>
