                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                    {!! Form::open(['url' => route('profiles.update', $user->id), 'method' => 'post', 'files' => true]) !!}
                                    <div class="media">
                                        <a href="javascript: void(0);">
                                            <img src="{{ $user->image ? asset('web_asset/profile/'.$user->image) : asset('pvktii/profile.png') }}" class="rounded mr-75" alt="profile image" height="64" width="64">
                                        </a>
                                        <div class="media-body mt-75">
                                            ...
                                            <p class="text-muted ml-75 mt-50"><small>Allowed JPG, GIF or PNG. (Max. 1MB)</small></p>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    {!! Form::text('alamat', $user->alamat, ['class' => 'form-control', 'required']) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="tab-pane fade " id="account-vertical-password" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                    {!! Form::open(['url' => route('auth.change_password'), 'method' => 'post']) !!}
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="controls">
